...
function tick()
{
    ...
    {
      document.getElementById('time').style.color = "#f4e542e"
    }
...
function end()
{
    ...
    // x.
    document.getElementById('time').style.color = "#d3120e";
    ...
    for (var i=0; i<is_guessed.length; i++)
    {
        ...
        {
          document.getElementById(id).style.backgroundColor = "#d3120e";
        }
